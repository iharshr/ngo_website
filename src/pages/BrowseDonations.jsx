					...
					{articles.map((article, index) => (
						...
						>
							...
							<div className="flex flex-1 flex-col p-4 sm:p-6">
								...
								<button className="cursor-pointer block rounded-lg bg-red-500 bg-opacity-50 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-red-300 transition duration-100 hover:bg-red-300 focus-visible:ring active:bg-red-400 md:text-base">
									Donate Now
								</button>
							</div>
						</div>
